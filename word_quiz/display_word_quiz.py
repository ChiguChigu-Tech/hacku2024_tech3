...
def reset_quiz():
    ...
    if 'quiz_list' in st.session_state:
        del st.session_state.quiz_list  # クイズのリストをリセット
    if 'current_quiz_index' in st.session_state:
        del st.session_state.current_quiz_index  # 現在のクイズインデックスをリセット
    if 'score' in st.session_state:
        del st.session_state.score  # スコアをリセット
    if 'results' in st.session_state:
        del st.session_state.results  # 結果をリセット
    if 'show_results' in st.session_state:
        del st.session_state.show_results  # 結果画面フラグをリセット
...
def main():
    ...
    if 'quiz_list' not in st.session_state:
        ...
        | オプション名 | 説明 |
        |:-----|:-----:|
        | **基本単語もーど** | 単語検索画面より、登録された単語をテストします。 |
        | **論文もーど** | 論文登録より、論文から抽出された単語をテストします。 |
        | **ガッチャンコもーど** | 単語検索と論文登録の両方単語をテストします。 |
        '''
